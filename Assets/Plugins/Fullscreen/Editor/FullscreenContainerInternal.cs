...
namespace FullscreenEditor
{
    ...
    {
        /// <summary>
        ///     The m_src will have all it's fields null if we've instantiated the window by ourselves.
        ...
        /// <param name="rect">
        ///     The initial position of the ContainerWindow, can be changed later using the <see cref="Rect" />
        ///     property.
        /// </param>
