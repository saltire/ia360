...
namespace FullscreenEditor
{
    ...
    public static class Fullscreen
    {
        ...
        {
            GetAllFullscreen(false);

            FullscreenCallbacks.beforeFullscreenOpen += f => GetAllFullscreen(false);
            FullscreenCallbacks.afterFullscreenOpen += f => GetAllFullscreen(false);
            FullscreenCallbacks.beforeFullscreenClose += f => GetAllFullscreen(false);
            FullscreenCallbacks.afterFullscreenClose += f => GetAllFullscreen(false);
        }
        ...
        /// <summary>
        ///     Returns the parent <see cref="FullscreenContainer" /> for a given view or window, or null if it's not in
        ///     fullscreen.
        /// </summary>
        ...
        /// <param name="window">
        ///     The window that will go fullscreen. If null a new one will be instantiated based on the given
        ///     type.
        /// </param>
        ...
        ///     type.
        /// </param>
        /// <param name="disposableWindow">
        ///     Set this to true when the target window was created solely for fullscreen,
        ///     this will cause it to be destroyed once the fullscreen closes, it has no effects if the target window is null.
        /// </param>
        /// <returns>Returns the newly created <see cref="FullscreenWindow" />.</returns>
