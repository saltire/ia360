...
namespace FullscreenEditor
{
    ...
    public static class FullscreenUtility
    {
        ...
        public static EditorWindow GetMainGameView()
        {
            ...
            if (Types.PreviewEditorWindow.HasMethod("GetMainPreviewWindow")) // Removed in 2019.3 beta
        ...
        public static void FocusView(ScriptableObject guiView)
        {
            ...
            else
            {
                ...
                if (vc)
                {
                    if (vc.HasMethod(methodName, new[] { typeof(bool), typeof(bool), typeof(bool) }))
        ...
        public class Icon
        {
            private readonly string m_base64;
            ...
            public Texture2D Texture => m_texture ? m_texture : m_texture = FindOrLoadTexture(m_base64);
