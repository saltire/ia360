...
namespace FullscreenEditor
{
    ...
    public class DisplayInfo
    {
        ...
        public float ScreenHeight => MonitorArea.yMax - MonitorArea.yMin;

        public float ScreenWidth => MonitorArea.xMax - MonitorArea.xMin;

        public string DeviceName => displayDevice.DeviceName;

        public string FriendlyName => displayDevice.DeviceString;
        ...
        public float scaleFactor => devMode.dmPelsWidth / (MonitorArea.xMax - MonitorArea.xMin);
        ...
        public static DisplayInfo GetDisplay(int index)
        {
            ...
            if (displays != null && index >= 0 && index < displays.Count) return displays[index];
        ...
        {
            for (var id = 0; id < displayInfo.Count; id++)
            {
